        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            try {
                if (name === 'stock_get') {
                    ...
                    const data = await fetchStock(params.code, params.market);
                    return {
                        content: [
                            {
                                type: 'text',
                ...
                if (name === 'position_add') {
                    ...
                    const result = position.addPosition(params.code, params.name, params.quantity, params.costPrice, params.currency, params.market);
                    return {
                        content: [
                            {
                                type: 'text',
                ...
                if (name === 'position_update') {
                    ...
                    const result = position.updatePosition(params.code, params.market, {
                ...
                if (name === 'position_remove') {
                    ...
                    const success = position.removePosition(params.code, params.market);
                    if (!success) {
                        throw new Error('Position not found');
                    }
                    return {
                ...
                if (name === 'position_get') {
                    ...
                    const result = position.getPosition(params.code, params.market);
                    if (!result) {
                        throw new Error('Position not found');
                    }
                    return {
                ...
                if (name === 'watch_add') {
                    ...
                    const result = watch.addWatch(params.code, params.name, params.reason, params.market);
                    return {
                        content: [
                            {
                                type: 'text',
                ...
                if (name === 'watch_update') {
                    ...
                    const result = watch.updateWatch(params.code, params.market, {
                        name: params.name,
                ...
                if (name === 'watch_remove') {
                    ...
                    const success = watch.removeWatch(params.code, params.market);
                    if (!success) {
                        throw new Error('Watch item not found');
                    }
                    return {
                ...
                if (name === 'watch_get') {
                    ...
                    const result = watch.getWatch(params.code, params.market);
                    if (!result) {
                        throw new Error('Watch item not found');
                    }
                    return {
